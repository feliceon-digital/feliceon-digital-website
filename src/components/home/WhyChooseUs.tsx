...
const WhyChooseUs = () => {
  ...
  return <section className="section-padding bg-gradient-to-br from-feliceon-darkblue to-feliceon-blue text-white">
      <div className="container mx-auto">
        <div className="section-heading">
          <h2 className="font-bold text-lime-500">Why Choose Us</h2>
          <p className="text-white">What makes Feliceon Digital Solusi your ideal technology partner</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-10">
          {reasons.map((reason, index) => <div key={index} className="flex items-start">
        ...
        <div className="mt-16 p-6 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20">
          <div className="flex flex-col md:flex-row md:items-center justify-between">
            <div className="mb-4 md:mb-0">
              ...
              <p className="text-white">Let's discuss how we can help you achieve your goals.</p>
            </div>
            <a href="/contact" className="inline-flex items-center justify-center px-6 py-3 bg-white text-feliceon-blue rounded-md font-medium hover:bg-blue-50 transition-colors">
